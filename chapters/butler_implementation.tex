...
\captionof{listing}{Butler Delly Workflow analysis configuration for deletions genotyping.\label{lst:analysis_1_percent_maf}}
\begin{minted}
[
breaklines=true,
breakanywhere=true,
...
\captionof{listing}{Butler Delly Workflow analysis configuration for duplications genotyping.\label{lst:analysis_1_percent_maf}}
\begin{minted}
[
breaklines=true,
breakanywhere=true,
...
Figure \ref{fig:delly_dup_durations} shows a histogram of genotyping job durations.
