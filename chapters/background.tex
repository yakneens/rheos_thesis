...
\begin{description}
    ...
    \begin{figure}[H]
        \includegraphics[scale=0.30]{fastqc_adapter_content}
        \centering
        \caption {Taken from https://www.bioinformatics.babraham.ac.uk/projects/fastqc.}
