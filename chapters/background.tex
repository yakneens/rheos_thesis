...
Alignment records represent the information contained in a sequencing read subsequent to it being aligned to a reference genome (see Figure \ref{fig:bg_read_pair}).
...
\begin{figure}[H]
    \includegraphics[scale=0.8]{svaba_method}
    \centering
