...
\captionof{listing} {Collectd configuration for metrics collection. \label{lst:collectd_config}}
\begin{minted}
[
breaklines=true,
linenos,
...
<Plugin network>
  Server "influxdb.service.consul" "8096"
</Plugin>
\end{minted}
...
\captionof{listing}{Butler Delly Workflow analysis configuration to genotype deletions.\label{lst:run_delly}}
\begin{minted}
[
breaklines=true,
breakanywhere=true,
